...
struct ColorScheme
{
    ...
    */
    ...
    static struct Scroll
    {
        ...
        static struct Area
        {
			RGBA back = RGBA(200, 200, 200, 255);
        ...
        static struct Bar
        {
			RGBA back = RGBA(255, 255, 255, 64);
			RGBA thumb = RGBA(0, 0, 0, 96);
            RGBA thumbHover = RGBA(0, 0, 0, 96);
            RGBA thumbPress = RGBA(0, 0, 0, 196);
        }
    ...
    {
        RGBA text         = RGBA(0, 0, 0, 255);
        RGBA textHover    = RGBA(0, 50, 0, 255);
        RGBA textDisabled = RGBA(128, 128, 128, 200);
        RGBA back         = RGBA(96, 96, 96,  96);
