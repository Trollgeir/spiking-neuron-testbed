...
class DebugDraw : b2Draw
{
    ...
    {
		import framework.render : test;
		b2Color fillColor = b2Color(0f * color.r, 0f * color.g, 0f * color.b, 1f);//test.bodyColor;//b2Color(1f, 1f, 1f);
		color = b2Color(0f * color.r, 0f * color.g, 0f * color.b, 1f);
    ...
    override void DrawSolidCircle(b2Vec2 center, float32 radius, b2Vec2 axis, b2Color color)
    {
        ...
        b2Vec2  v1 = center + radius * r1;
        b2Color fillColor = b2Color(1f * color.r, 1f * color.g, 1f * color.b, 1f * color.a);
		color = b2Color(0f * color.r, 0f * color.g, 0f * color.b, 1f);
    ...
    void DrawString(int x, int y, string str, TextAlign ali = TextAlign.left)
    {
        int h = g_camera.m_height;
        addGfxCmdText(x, h - y, ali, str, RGBA(0, 0, 0, 255));
    }

	void DrawString(b2Vec2 pw, string str, TextAlign ali = TextAlign.left)
    {
        b2Vec2  ps = g_camera.ConvertWorldToScreen(pw);
        int h  = g_camera.m_height;
        addGfxCmdText(cast(int)ps.x, cast(int)(h - ps.y), ali, str, RGBA(0, 0, 0, 255));
    }
...
struct GLRenderPoints
{
	...
	b2Vec2[e_maxVertices] m_vertices;
	b2Color[e_maxVertices] m_colors;
	float32[e_maxVertices] m_sizes;
